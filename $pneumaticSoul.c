...
#pragma config(Motor,  port7,           shoulder3,     tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           wristMotor,         tmotorVex393_MC29, openLoop, reversed)
...
void pre_auton() {
  ...
  configureButtonInput(shoulder, shoulderUpBtn, shoulderDownBtn, shoulderStillSpeed);
...
void liftControl() {
	...
	shoulder.stillSpeed = liftStillSpeed * ((potPos<liftMiddle || potPos>liftVert) ? 1 : -1);
