#pragma config(Sensor, in1,    lowLiftPot,     sensorPotentiometer)
#pragma config(Sensor, in2,    highLiftPot,    sensorPotentiometer)
...
void liftControl() {
	...
	setPower(highLift, (fourBar ? liftPower : liftStillSpeed));
}
