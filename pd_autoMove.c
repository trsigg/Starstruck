...
int defDriveInts[5] = { 1000, 30, 100, 100, 50 }; //timeout, brakePower, waitAtEnd, brakeDuration, sampleTime
float defDriveFloats[7] = { 120, 0, 3, 0, 0, 0, 40 }; //initialPower, maxPower/kP_r, finalPower/kD_r, kP_c, kI_c, kD_c, minSpeed
//end drive defaults
